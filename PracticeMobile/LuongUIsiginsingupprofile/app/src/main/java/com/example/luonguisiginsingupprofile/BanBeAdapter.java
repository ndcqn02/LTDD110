...
//        imgHinh.setImageResource(banBe.getHinh());  // load img bang int drawable
        Glide.with(this.context).load(banBe.getHinh()).into(imgHinh);  // load img bang String internet
